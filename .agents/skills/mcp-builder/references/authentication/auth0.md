...
With environment variables configured outside the repo:

- Auth0 domain: your tenant domain
- Auth0 client ID: from the Regular Web App
- Auth0 client secret: from the Regular Web App secret store
- Auth0 audience: the MCP API audience
