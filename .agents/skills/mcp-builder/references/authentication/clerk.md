...
Development uses a Clerk accounts domain such as `https://[verb-noun-##].clerk.accounts.dev`.
Production uses the application Clerk domain, such as `https://clerk.[YOUR_APP_DOMAIN].com`.
