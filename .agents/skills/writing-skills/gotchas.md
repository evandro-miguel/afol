...
```yaml
# ❌ BAD: Line breaks or >- syntax
description: Use when creating skills.
  Also for updating.

# ❌ BAD: OpenCode doesn't accept >-
description: >-
  Use when creating or updating skills.

# ✅ GOOD: Single line description
description: Use when creating or updating skills. Triggers for new skill, update skill.
```
...
## Anti-Patterns (from Anthropic Guide)
