---
description: Complete copy-paste templates for each skill type.
metadata:
  tags: "examples, templates, copy-paste"
---
...
---
name: technique-name
description: Applies when [specific symptom] occurs.
metadata:
  category: technique
  tags: "technique, guide, how-to"
...
---
name: reference-name
description: Reference for working with [domain].
metadata:
  category: reference
  tags: "reference, docs, cheat-sheet"
...
description: Enforces [rule] before [violation point].
metadata:
  category: discipline
  tags: "discipline, rule, enforcement"
...
---
name: pattern-name
description: Pattern for addressing [recognizable symptom].
metadata:
  category: pattern
  tags: "pattern, mental-model, refactoring"
...
description: Fixes race conditions and timing dependencies in tests.
metadata:
  category: technique
  tags: "testing, async, stability"
