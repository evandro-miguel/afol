---
description: Techniques for bulletproofing skills against agent rationalization.
metadata:
  tags: "anti-rationalization, discipline, loopholes"
---
...
> 📖 **Deep Dive**: See [Persuasion Principles](./persuasion.md) for detailed application of each principle with examples.
