...
**Stats:** 110 files, 32,333 lines, 1153.3 KB
...
| `.agents/scripts/agents-bootstrap.py` | 866 | 36.2 KB | Module; functionality |
| `.agents/scripts/agents-skills-sync.py` | 753 | 28.6 KB | Module; functionality |
...
| `.agents/scripts/agents-doctor.py` | 566 | 22.1 KB | Module; functionality |
| `.agents/scripts/agents-update/agents-update.py` | 526 | 20.0 KB | Module; functionality |
| `.agents/scripts/lib/execution_commands.py` | 524 | 21.4 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/check-skill.js` | 465 | 13.8 KB | Module; functionality |
| `.agents/skills/writing-skills/scripts/run_eval.py` | 450 | 15.1 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/writing-skills/scripts/run_eval.py` | 450 | 15.1 KB | Module; functionality |
| `.agents/skills/writing-skills/eval-viewer/generate_review.py` | 418 | 13.5 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/scripts/design_system.py` | 418 | 20.5 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/writing-skills/eval-viewer/generate_review.py` | 418 | 13.5 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/check-tier-migration.js` | 408 | 13.4 KB | Module; functionality |
| `.agents/skills/writing-skills/scripts/run_loop.py` | 392 | 14.5 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/writing-skills/scripts/run_loop.py` | 392 | 14.5 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/frontend-slides/convert_ppt.py` | 392 | 12.7 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/product-manager-toolkit/scripts/customer_interview_analyzer.py` | 363 | 16.8 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/run_grader.py` | 321 | 12.2 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/skill-read.js` | 280 | 8.4 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/writing-skills/scripts/skill-files.js` | 280 | 8.9 KB | Module; functionality |
...
| `.agents/cache/universal-skills/scripts/markdown-link-guard.js` | 271 | 7.3 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/product-manager-toolkit/scripts/rice_prioritizer.py` | 248 | 11.4 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/document-processing/scripts/ai-enhance-notes.py` | 211 | 7.5 KB | Module; functionality |
| `.agents/skills/writing-skills/scripts/improve_description.py` | 209 | 7.7 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/writing-skills/scripts/improve_description.py` | 209 | 7.7 KB | Module; functionality |
...
| `.agents/scripts/lib/agents_config.py` | 193 | 6.9 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/aggregate_benchmark.py` | 192 | 7.8 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/document-processing/scripts/extract-structure.py` | 183 | 7.0 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/document-processing/scripts/link-notes-to-source.py` | 178 | 6.6 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/document-processing/scripts/create-obsidian-note.py` | 166 | 3.5 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/cleanup-empty-folders.js` | 159 | 4.3 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/document-processing/scripts/pdf-to-markdown.py` | 158 | 5.9 KB | Module; functionality |
...
| `.agents/scripts/agents-repo-map.py` | 143 | 6.6 KB | Module; functionality |
...
| `.agents/cache/universal-skills/scripts/generate-skills-inventory.js` | 131 | 4.2 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/writing-skills/scripts/utils.py` | 96 | 3.7 KB | Module; functionality |
| `.agents/scripts/migrate-task-board.py` | 87 | 3.9 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/scripts/search.py` | 64 | 3.2 KB | Module; functionality |
