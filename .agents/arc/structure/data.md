...
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/shadcn.csv` | 61 | 15.5 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/styles.csv` | 59 | 40.0 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/nuxtjs.csv` | 59 | 16.2 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/typography.csv` | 58 | 31.1 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/html-tailwind.csv` | 56 | 11.1 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/react.csv` | 54 | 12.7 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/svelte.csv` | 54 | 10.8 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/flutter.csv` | 53 | 10.2 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/nextjs.csv` | 53 | 12.3 KB | Module; functionality |
...
| `.agents/cache/universal-skills/skills/ux-skill/data/stacks/vue.csv` | 50 | 10.8 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/unreal-engine/references/assets/configuration.md` | 49 | 1.4 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/unreal-engine/references/actors/configuration.md` | 49 | 1.3 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/react-performance.csv` | 45 | 14.5 KB | Module; functionality |
| `.agents/cache/universal-skills/arq/skills-deprecated/opencode-expert/references/config/providers.md` | 44 | 1.0 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/react-skill/references/frontend-patterns/resources/data-fetching.md` | 42 | 1.3 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/unreal-engine/references/getting-started/configuration.md` | 42 | 1.3 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/unreal-engine/references/mcp/configuration.md` | 41 | 1.0 KB | Module; functionality |
| `.agents/cache/universal-skills/arq/skills-deprecated/opencode-expert/references/config/themes-and-keybinds.md` | 40 | 0.7 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/unreal-engine/references/metadata/README.md` | 39 | 1.4 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/landing.csv` | 31 | 14.0 KB | Module; functionality |
| `.agents/cache/universal-skills/skills/ux-skill/data/web-interface.csv` | 31 | 7.3 KB | Module; functionality |
| `.agents/cache/universal-skills/arq/skills-deprecated/opencode-expert/references/config/custom-commands.md` | 29 | 0.9 KB | Module; functionality |
