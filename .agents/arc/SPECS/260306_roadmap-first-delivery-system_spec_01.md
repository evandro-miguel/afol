...
Touched layers:
- Strategic docs (`.agents/arc/`)
- Templates and standards (`.agents/a-docs/`)
...
- Feature-centric roadmap structure in `.agents/arc/GENERAL-ROADMAP.md`
- Parent spec model in `.agents/arc/SPECS/`
...
- Q-03 Should child specs live only in `.agents/arc/SPECS/` or also have indexed groupings by parent feature?
...
---
*Spec: `.agents/arc/SPECS/260306_roadmap-first-delivery-system_spec_01.md`*
