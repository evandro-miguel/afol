...
- Risk: a second governance system emerges by accident -> Mitigation: keep `.agents/arc`, `.agents/wb`, and runtime mirrors canonical; forbid parallel track trees.
...
- Open questions:
  - Q-01 Which parts of project context should live in `.agents/arc/` versus runtime-facing mirrors only?
