...
description: Use when working with bun development tasks. Covers setup, core workflows,
  diagnostics, and common pitfalls with concise, actionable guidance aligned to OpenCode
  standards for safe execution, verification, and consistent results.
metadata:
  category: runtime
  tags: "bun-development"
  triggers: "bun dev, bun development, bun setup, bun workflow"
  references: "bun-development"
---
...
- Start with the current bun development context and constraints.
- Apply the smallest change that achieves the goal, then verify.

## Examples

- Apply bun development guidance to a focused task with measurable output.

## Common Mistakes

- Skipping validation steps specific to bun development.
- Introducing changes without aligning to existing conventions.
