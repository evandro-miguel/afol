---
description: Validation and recovery guidance for scaffold install, upgrade, and skills drift
metadata:
  tags: "agentic-system, troubleshooting, validation, bootstrap, skills-sync"
---
