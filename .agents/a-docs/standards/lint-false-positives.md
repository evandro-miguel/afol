...
- `tool-doc` - Agent tool documentation (`.agents/a-docs/agentic/`)
- `lesson_entry` - Lesson entries (`.agents/a-docs/lessons/entries/`)
...
Files in `.agents/rules/` and `.agents/a-docs/standards/` that show examples:
...
---
*Document: `.agents/a-docs/standards/lint-false-positives.md`*
