...
### No events recorded
- Check if `events.jsonl` exists: `ls -la .agents/a-docs/telemetry/data/`
...
- `.agents/a-docs/patterns/` - Pattern catalog
- `.agents/a-docs/lessons/` - Lessons learned
- `.agents/tools.json` - Tool catalog

---
*Telemetry Guide: `.agents/a-docs/telemetry/README.md`*
