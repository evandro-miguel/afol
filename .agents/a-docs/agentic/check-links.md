...
```bash
# Check default directory (.agents/a-docs/)
python3 .agents/scripts/check-links.py

# Check specific directory
python3 .agents/scripts/check-links.py .agents/a-docs/agentic/

# Check multiple directories
python3 .agents/scripts/check-links.py .agents/a-docs/ .agents/arc/
```
...
### Verbose Mode
```
Checking .agents/a-docs/agentic/...
  ✓ .agents/a-docs/agentic/agents-tools.md:25 ./tools-json.md (File exists)
  ✓ .agents/a-docs/agentic/agents-doctor.md:30 ./agents-config.md (File exists)
  ✗ .agents/a-docs/agentic/INDEX.md:50 ./missing.md (Target not found)
```
...
---
*Document: `.agents/a-docs/agentic/check-links.md`*
