...
| `afol evolve` | Operator inspects project identity, migration state, and production-day projection. | Status remains read-only and reports uninitialized, healthy, or repair-needed state without creating the derived DB. | evolution Slice 1 scripted scenario. |
