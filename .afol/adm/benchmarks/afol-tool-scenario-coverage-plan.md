...
| `afol skill` | Agent resolves optional project-local skills. | scripted skill list/show plus live routing scenario. | AFOL operation remains rule-first: `AGENTS.md`, resolved `.afol/adm/rules/**`, and `afol help <command>`; no operator skill is required or vendored. |
