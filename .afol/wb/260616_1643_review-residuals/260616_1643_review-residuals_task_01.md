...
| T-02 | pending | builder | `ctx` side-effect registry accuracy; cover bundle/index behavior and registry/help metadata if needed. |
| T-03 | pending | builder | Maintenance dry-run plan UX; touch registry metadata only if maintenance output metadata truly changes. |
