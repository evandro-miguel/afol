...
spec_waiver_reason: ""
closed_at: "2026-08-22T18:17:28.192Z"
---

# Tasks: public-readiness-remediation

## State Board

| Task | State | Owner | Notes |
|------|-------|-------|-------|
| T-01 | done | worker | Repair release health and derived indexes attempt=1 |
...
| T-05 | done | worker | Validate the unpublished release candidate attempt=3 |
