...
| `docs/telemetry/schemas/event.json` | Event schema |
| `docs/telemetry/README.md` | Telemetry usage guide |
| `docs/telemetry/dashboard.md` | Metrics dashboard |
| `docs/patterns/TEMPLATE_pattern.md` | Pattern template |
| `docs/patterns/INDEX.md` | Pattern catalog index |
| `docs/patterns/success/PAT-001_discovery-first.md` | Discovery-first pattern |
| `docs/patterns/success/PAT-002_single-active-session.md` | Single session pattern |
| `docs/patterns/anti/PAT-101_workbench-sprawl.md` | Workbench sprawl anti-pattern |

### Files Modified

| Path | Changes |
|------|---------|
| `docs/standards/Makefile` | Added telemetry/patterns targets, updated `make all` |
