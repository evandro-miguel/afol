...
**Stats:** 101 files, 31,739 lines, 1311.1 KB
...
| `src/project-template/.agents/scripts/agents-skills-sync.py` | 1,175 | 49.1 KB | Module; functionality |
...
| `.agents/scripts/lib/execution_commands.py` | 820 | 33.8 KB | Module; functionality |
...
| `.agents/scripts/agents-wb-update.py` | 676 | 26.7 KB | Module; functionality |
| `src/project-template/.agents/scripts/agents-wb-update.py` | 676 | 26.7 KB | Module; functionality |
