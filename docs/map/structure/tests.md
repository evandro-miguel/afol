...
**Stats:** 67 files, 10,189 lines, 473.7 KB
...
| `docs/map/structure/tests.md` | 79 | 6.7 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_mcp.py` | 66 | 3.0 KB | Test file; unit tests |
| `.agents/runtime/tests/test_cli.py` | 62 | 3.2 KB | Test file; unit tests |
| `.agents/runtime/tests/test_runtime.py` | 58 | 2.4 KB | Test file; unit tests |
...
| `docs/arc/SPECS/INDEX.md` | 44 | 4.2 KB | Module; functionality |
