...
**Stats:** 133 files, 28,254 lines, 1370.1 KB

### Files

| File | Lines | Size | Description |
|------|-------|------|-------------|
| `.agents/scripts/tests/test_cli_utility_coverage.py` | 1,188 | 58.6 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_runtime_compatibility.py` | 793 | 43.2 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_runtime_compatibility.py` | 793 | 43.2 KB | Test file; unit tests |
...
| `.agents/scripts/tests/integration/test_critical_workflows.py` | 361 | 16.4 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_agents_status.py` | 281 | 14.7 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_runtime.py` | 199 | 10.5 KB | Test file; unit tests |
| `.agents/scripts/tests/test_agents_review.py` | 198 | 11.1 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_agents_review.py` | 198 | 11.1 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_mcp.py` | 110 | 5.0 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_cli.py` | 91 | 4.7 KB | Test file; unit tests |
