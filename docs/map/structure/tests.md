...
| `.agents/scripts/tests/test_agents_bootstrap.py` | 367 | 21.1 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_agents_bootstrap.py` | 363 | 20.9 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_agents_benchmark.py` | 301 | 12.6 KB | Test file; unit tests |
| `docs/arc/SPECS/260521_0110_validation-ci-and-benchmarks_spec_01.md` | 292 | 10.2 KB | Module; functionality |
...
| `cli/tests/validation.test.ts` | 212 | 9.1 KB | Test file; unit tests |
...
| `docs/arc/SPECS/260521_0030_agent-command-design-system_spec_01.md` | 140 | 3.9 KB | Module; functionality |
| `docs/arc/SPECS/260521_0100_runtime-adapters-and-mcp_spec_01.md` | 139 | 4.9 KB | Module; functionality |
...
| `docs/arc/SPECS/260521_0020_minimal-project-template_spec_01.md` | 127 | 4.1 KB | Module; functionality |
...
| `docs/arc/SPECS/260521_0080_safe-file-mutation-and-undo_spec_01.md` | 51 | 1.9 KB | Module; functionality |
| `docs/arc/SPECS/260521_0060_file-first-low-token-execution_spec_01.md` | 51 | 1.9 KB | Module; functionality |
| `docs/arc/SPECS/F-03/spec-tests/260521_0135_agent-command-design-system_spec-test_01.md` | 51 | 1.8 KB | Test file; unit tests |
| `docs/arc/SPECS/260521_0070_local-state-index-and-event-log_spec_01.md` | 50 | 1.9 KB | Module; functionality |
