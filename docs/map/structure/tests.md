...
**Stats:** 166 files, 37,417 lines, 1798.1 KB
...
| `.agents/scripts/tests/test_agents_scaffold_update.py` | 574 | 30.6 KB | Test file; unit tests |
...
| `cli/tests/validation.test.ts` | 507 | 22.7 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_execution_command_flow.py` | 441 | 22.8 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_agents_session.py` | 336 | 17.8 KB | Test file; unit tests |
| `.agents/skills/node/rules/flaky-tests.md` | 331 | 10.4 KB | Test file; unit tests |
| `docs/arc/SPECS/260521_0110_validation-ci-and-benchmarks_spec_01.md` | 331 | 11.8 KB | Module; functionality |
| `src/project-template/.agents/scripts/tests/test_agents_session.py` | 328 | 17.3 KB | Test file; unit tests |
| `.agents/scripts/tests/test_agents_implement.py` | 322 | 18.4 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_agents_implement.py` | 322 | 18.4 KB | Test file; unit tests |
| `.agents/scripts/tests/test_agents_status.py` | 316 | 16.3 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_agents_status.py` | 316 | 16.3 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_runtime.py` | 247 | 13.1 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_front_door_a.py` | 215 | 10.1 KB | Test file; unit tests |
...
| `cli/tests/kernel.test.ts` | 202 | 8.8 KB | Test file; unit tests |
...
| `docs/arc/SPECS/260521_0010_universal-agent-cli_spec_01.md` | 162 | 6.4 KB | Module; functionality |
...
| `docs/arc/SPECS/260521_0030_agent-command-design-system_spec_01.md` | 153 | 4.7 KB | Module; functionality |
...
| `src/project-template/.agents/runtime/tests/test_runtime.py` | 113 | 5.4 KB | Test file; unit tests |
...
| `src/project-template/.agents/runtime/tests/test_cli.py` | 95 | 4.6 KB | Test file; unit tests |
...
| `docs/arc/SPECS/INDEX.md` | 82 | 13.6 KB | Module; functionality |
...
| `.agents/scripts/tests/test_agents_tools_catalog.py` | 73 | 3.5 KB | Test file; unit tests |
...
| `.agents/scripts/tests/unit/test_agents_config_active_session.py` | 57 | 3.3 KB | Test file; unit tests |
| `docs/arc/SPECS/260521_0040_governance-workbench-system_spec_01.md` | 57 | 2.3 KB | Module; functionality |
| `docs/arc/SPECS/260521_0120_public-distribution-and-onboarding_spec_01.md` | 56 | 2.3 KB | Module; functionality |
...
| `src/project-template/.agents/scripts/tests/unit/test_agents_config_active_session.py` | 44 | 2.4 KB | Test file; unit tests |
...
| `src/project-template/.agents/scripts/tests/test_agents_config_parse_offset.py` | 36 | 1.9 KB | Test file; unit tests |
