...
**Stats:** 106 files, 17,682 lines, 821.3 KB

### Files

| File | Lines | Size | Description |
|------|-------|------|-------------|
| `.agents/scripts/tests/test_cli_utility_coverage.py` | 1,126 | 55.6 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_cli_utility_coverage.py` | 1,125 | 55.5 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_runtime_compatibility.py` | 382 | 21.0 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_agents_new_quick_mode.py` | 358 | 16.1 KB | Test file; unit tests |
| `.agents/scripts/tests/integration/test_critical_workflows.py` | 328 | 14.6 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/integration/test_critical_workflows.py` | 328 | 14.6 KB | Test file; unit tests |
| `src/project-template/.agents/scripts/tests/test_runtime_compatibility.py` | 316 | 17.6 KB | Test file; unit tests |
...
| `.agents/scripts/tests/test_agents_repo_map.py` | 175 | 7.6 KB | Test file; unit tests |
...
| `src/project-template/.agents/scripts/tests/test_agents_repo_map.py` | 137 | 6.0 KB | Test file; unit tests |
| `.agents/scripts/tests/test_agents_telemetry.py` | 130 | 6.6 KB | Test file; unit tests |
| `.agents/scripts/tests/test_agents_bootstrap.py` | 125 | 7.0 KB | Test file; unit tests |
...
| `src/project-template/.agents/scripts/tests/test_agents_bootstrap.py` | 86 | 4.8 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_runtime.py` | 81 | 3.8 KB | Test file; unit tests |
| `.agents/runtime/tests/test_mcp.py` | 78 | 3.7 KB | Test file; unit tests |
...
| `docs/map/structure/tests.md` | 75 | 6.4 KB | Test file; unit tests |
...
| `.agents/runtime/tests/test_cli.py` | 62 | 3.2 KB | Test file; unit tests |
...
| `docs/arc/SPECS/INDEX.md` | 46 | 4.8 KB | Module; functionality |
