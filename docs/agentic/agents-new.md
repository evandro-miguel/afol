...
| File | Change |
|------|--------|
| `.afol/wb/.active_session` | Points to new session |
...
- `--into-session` must target an existing session under `.afol/wb/`; do not use `/tmp` or a copied workbench path.
...
def create_session_folder(session_id: str) -> Path:
    """Create session folder in .afol/wb/."""
...
1. Edit: .afol/wb/260223_1800_auth-refactor/260223_1800_auth-refactor_plan_01.md
2. Edit: .afol/wb/260223_1800_auth-refactor/260223_1800_auth-refactor_task_01.md
```
