...
# 2026-02-23 - `docs` must remain documentation-only

## Context

User correction requested an explicit rule: `docs` is only for documentation.
...
Never store runtime state, cache, mirrors, generated artifacts, or operational data under `docs/`.
