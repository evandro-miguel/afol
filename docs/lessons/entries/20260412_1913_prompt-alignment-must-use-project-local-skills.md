...
updated_at: '2026-04-12T19:13:50-03:00'
---
...
- Before rewriting scaffold operating prompts, inspect the current repo-local
  `AGENTS.md`, `.agents/skills/`, `.agents/agents.config`, and relevant CLI help.
...
- For this repository, route governed scaffold/workbench operations through
  `agentic-folder-sys`; do not reintroduce the older split between
  `agentic-system-workflow` and `workbench-agent-teams`.
