...
This project is indexed by GitNexus as **agentic-standard-folder** (5335 symbols, 7669 relationships, 299 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
