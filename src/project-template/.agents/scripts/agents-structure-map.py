...
Examples:
    ...
    python agents-structure-map.py /path/to/project --output docs/map/structure/
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("  python agents-structure-map.py /path/to/project --output docs/map/structure/")
        sys.exit(1)
