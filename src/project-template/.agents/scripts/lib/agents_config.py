...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "paths": {
        ...
        "tmp_dir": ".agents/tmp",
        "archive_dir": ".agents/z-arq",
        "journal_dir": ".agents/journal/agentic-runtime",
        "bootstrap_manifest_file": ".agents/bootstrap-manifest.json",
    ...
    "workflow": {
        "artifact_manifest": {
            ...
            "legacy": {
                ...
                "optional_artifacts": ["spec", "spec-child", "spec-test", "spec-lite"],
                "spec_flags": {
                    "spec": "use_spec",
                    "spec-child": "use_spec_child",
                    "spec-lite": "use_spec_lite",
                    "spec-test": "use_spec_test",
                },
            },
        },
        "artifact_policy": {
