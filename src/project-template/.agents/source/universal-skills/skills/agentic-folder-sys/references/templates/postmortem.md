...
## Goal
- Capture what happened in the session so future agents can reuse the
  real outcome instead of reconstructing it.
...
## Memory Promotion
- Promote to repo docs: <yes/no + target>
- Promote to memory system: <none / /nota / governed-memory>
- Source artifacts: <session/report/postmortem ids or paths>
