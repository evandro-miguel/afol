...
export interface LiveRunnerProfile {
	runtime: string;
	model: string;
	reasoning_effort: string;
}

export interface LiveRunnerScenarioResult {
	id: string;
	pass: boolean;
	duration_ms: number;
	tool_call_count: number;
...
export interface LiveRunnerResultPayload {
	pack_id: string;
	generated_at: string;
	pass: boolean;
	duration_ms: number;
...
export interface RuntimeLiveEvidence {
