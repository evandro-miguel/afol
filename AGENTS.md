...
This project is indexed by GitNexus as **agentic-start-folder** (5389 symbols, 7877 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
