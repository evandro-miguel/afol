...
This project is indexed by GitNexus as **agentic-standard-folder** (5268 symbols, 7556 relationships, 296 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
